...
enum link__Purpose {
  ...
  SECURITY
  # features provide metadata necessary for operation execution.
  EXECUTION
}
...
type Query 
  @extraSchemaDefinitionDirective(directives: {transport: [{kind: "http", subgraph: "ExpenseService", location: "http://localhost:7502/graphql", headers: [["Content-Type", "application/json"], ["Accept", "application/json"]], options: {method: "POST", retry: 3, timeout: 10000}}]})
  @extraSchemaDefinitionDirective(directives: {transport: [{kind: "http", subgraph: "UserService", location: "http://localhost:7501/graphql", headers: [["Content-Type", "application/json"], ["Accept", "application/json"]], options: {method: "POST", retry: 3, timeout: 10000}}]})
